			   ...
			   enum rfk_tri_type rfk_tri_typ)
{
	...
	if (halrf_is_under_cac(rf, phy_idx)) {
		...
		/*[LOK, IQK]*/
		rtl8852be_halrf_iqk_trigger(rf, phy_idx, rfk_tri_typ);

		/*[TSSI Trk]*/
		rtl8852be_halrf_tssi_trigger(rf, phy_idx, true);

		/*[DPK]*/
		rtl8852be_halrf_dpk_trigger(rf, phy_idx, rfk_tri_typ);
...
enum rtw_hal_status rtl8852be_halrf_dack_trigger(void *rf_void, bool force)
{
...
enum rtw_hal_status rtl8852be_halrf_iqk_trigger(void *rf_void,
		       enum phl_phy_idx phy_idx,
		       bool force)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
...
void rtl8852be_halrf_lck_trigger(void *rf_void)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	struct rtw_hal_com_t *hal_i = rf->hal_com;
...
enum rtw_hal_status rtl8852be_halrf_dpk_trigger(void *rf_void,
		       enum phl_phy_idx phy_idx,
		       bool force)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
...
enum rtw_hal_status rtl8852be_halrf_tssi_trigger(void *rf_void, enum phl_phy_idx phy_idx, bool hwtx_en)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	struct rtw_hal_com_t *hal_i = rf->hal_com;
...
void rtl8852be_halrf_dpk_switch(void *rf_void, bool is_enable)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	...
	if (is_enable) {
		...
		rtl8852be_halrf_dpk_trigger(rf, HW_PHY_0, true);
...
void rtl8852be_halrf_watchdog(void *rf_void)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	bool lock = false;
...
void rtl8852be_halrf_psd_init(void *rf_void, enum phl_phy_idx phy,
...
void rtl8852be_halrf_psd_query(void *rf_void, enum phl_phy_idx phy,
