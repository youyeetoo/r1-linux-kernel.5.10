...
void halbb_ic_hw_setting_init_8852b(struct bb_info *bb)
{
	...
	if (bb->hal_com->cv != CAV) {
		...
		rtw_hal_mac_write_msk_pwr_reg(bb->hal_com, HW_PHY_0, 0xd240, 0x3fe00, 0x1d8);
		rtw_hal_mac_write_msk_pwr_reg(bb->hal_com, HW_PHY_1, 0xd240, 0x3fe00, 0x1d8);
		//set UL txpwr compensation to 0dB
		rtw_hal_mac_write_msk_pwr_reg(bb->hal_com, HW_PHY_0, 0xd290, 0x1f, 0);
		rtw_hal_mac_write_msk_pwr_reg(bb->hal_com, HW_PHY_1, 0xd290, 0x1f, 0);
	}
}
