...
extern s32 rtl8852be_rtw_make_wlanhdr(_adapter *padapter, u8 *hdr, struct pkt_attrib *pattrib);
...
extern u32 rtl8852be_rtw_calculate_wlan_pkt_size_by_attribue(struct pkt_attrib *pattrib);
#define rtw_wlan_pkt_size(f) rtl8852be_rtw_calculate_wlan_pkt_size_by_attribue(&f->attrib)
