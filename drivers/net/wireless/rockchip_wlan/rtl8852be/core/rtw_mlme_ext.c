...
void rtw_rfctl_update_op_mode(struct rf_ctl_t *rfctl, u8 ifbmp_mod, u8 if_op, u8 ifbmp_excl)
{
	...
	op_txpwr_max = rtl8852be_rtw_rfctl_get_oper_txpwr_max_mbm(rfctl, u_ch, u_bw, u_offset, ifbmp_mod, if_op, 1);
...
void update_sta_info(_adapter *padapter, struct sta_info *psta) {
	...
	/* psta->phl_sta->ra_info.is_support_sgi = rtl8852be_query_ra_short_GI(psta, rtw_get_tx_bw_mode(padapter, psta)); */
